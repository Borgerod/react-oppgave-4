...
const subjectDefinitions: {
	...
	// Simple single-topic mappings per user request
	{
		...
		topics: ["Category: Art"],
		icon: (
			<FaPalette className="w-8 h-8 text-ultra-light group-hover:text-[color:var(--background)]" />
		),
	},
	{
		name: "Business",
		...
		icon: (
			<FaBriefcase className="w-8 h-8 text-ultra-light group-hover:text-[color:var(--background)]" />
		),
	},
	{
		name: "Cooking",
		topics: ["Cooking"],
		icon: (
			<span className="cooking-pot text-ultra-light group-hover:text-[color:var(--background)]">
				<LuCookingPot
					color="currentColor"
	...
	},
	{
		...
		topics: ["Design"],
		icon: (
			<FaPencilRuler className="w-8 h-8 text-ultra-light group-hover:text-[color:var(--background)]" />
		),
	},
	{
		name: "Educational",
		...
		icon: (
			<FaBook className="w-8 h-8 text-ultra-light group-hover:text-[color:var(--background)]" />
		),
	},
	{
		name: "Craft",
		...
		icon: (
			<FaToolbox className="w-8 h-8 text-ultra-light group-hover:text-[color:var(--background)]" />
		),
	},
];
...
export default function SubjectGrid({ gridSize = 6 }: SubjectGridProps) {
	...
	const items = subjectDefinitions.slice(0, GridSize).map((def, i) => {
		...
		return (
			...
			>
				...
				<span className="row-start-1 col-start-1 self-end group-hover:text-[color:var(--background)]">
					{def.name}
				</span>
				...
				<span className="row-start-1 col-start-2 self-end flex items-end justify-end text-right group-hover:text-[color:var(--background)]">
				...
				<span className="row-start-2 col-start-2 text-xs text-secondary/50 self-start flex items-start justify-end text-right group-hover:text-[color:var(--background)]">
					Books
				</span>
				{/* </span> */}
			</Link>
